            ...
            <div className="grid md:grid-cols-3 gap-3">
              {CONTACT_CHANNELS.map(({ icon: Icon, label, primary, href, secondary, badge }) => (
                <motion.a key={label} href={href} target={href.startsWith("http") ? "_blank" : undefined} rel={href.startsWith("http") ? "noopener noreferrer" : undefined} whileHover={{ y: -2 }} transition={{ duration: 0.2 }} className="group relative bg-white border border-slate-100 rounded-2xl p-5 flex items-start gap-4 hover:border-[#1E4E8C]/25 hover:shadow-[0_4px_24px_rgba(30,78,140,0.08)] transition-all duration-300 overflow-hidden">
                  ...
                  <span className="relative p-2.5 rounded-xl bg-[#E6F0FA] text-[#1E4E8C] flex-shrink-0 border border-[#1E4E8C]/10"><Icon className="w-4.5 h-4.5" /></span>
                  <div className="relative min-w-0 space-y-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      <h3 className="font-black text-[9px] uppercase tracking-[.12em] text-slate-400">{label}</h3>
                      <span className="text-[9px] font-bold text-[#1E4E8C] bg-[#E6F0FA] border border-[#1E4E8C]/15 px-2 py-0.5 rounded-full whitespace-nowrap">{badge}</span>
                    </div>
          ...
          <div className="grid lg:grid-cols-12 gap-6 items-start">
            ...
            <RevealSection className="lg:col-span-5 flex flex-col gap-4" delay={0.1}>
              <div className="relative rounded-2xl overflow-hidden h-[210px] border border-slate-100 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
                <Image src="https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=800&auto=format&fit=crop" alt="Jevxo Services HQ Rajshahi" fill className="object-cover" sizes="(max-width: 768px) 100vw, 40vw" />
              ...
              <div className="bg-white border border-slate-100 rounded-2xl p-5 shadow-[0_1px_3px_rgba(0,0,0,0.03)]">
                <div className="flex items-center gap-2 mb-4"><div className="p-1.5 rounded-lg bg-[#E6F0FA]"><Clock className="w-3.5 h-3.5 text-[#1E4E8C]" /></div><h4 className="font-black text-[10px] text-slate-800 uppercase tracking-[.1em]">Office Hours</h4></div>
              ...
              <div className="bg-[#E6F0FA] border border-[#1E4E8C]/10 rounded-2xl p-5">
      ...
      <section className="pt-10 pb-4 md:py-14">
        <div className="max-w-3xl mx-auto px-4 md:px-6">
          <RevealSection className="text-center mb-8">
            <span className="inline-flex items-center gap-1.5 text-[10px] font-extrabold text-[#1E4E8C] uppercase tracking-[.12em] bg-[#E6F0FA] px-3.5 py-1.5 rounded-full border border-[#1E4E8C]/20 mb-4"><HelpCircle className="w-3 h-3" />General Help</span>
