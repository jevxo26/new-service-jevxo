      ...
      <div className="flex-1 bg-transparent flex flex-col justify-center py-20 px-4 md:px-6 relative overflow-hidden font-sans">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="text-center mb-12 space-y-4">
            <div className="inline-flex items-center gap-2 text-[10px] font-extrabold text-[#1E4E8C] uppercase tracking-[.12em] bg-[#E6F0FA] px-3.5 py-1.5 rounded-full border border-[#1E4E8C]/20">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <button key={role} onClick={() => handleSelectRole(role)} className="bg-white border border-slate-100/90 rounded-3xl p-8 hover:border-[#1E4E8C]/20 hover:shadow-[0_12px_40px_rgba(30,78,140,0.06)] hover:-translate-y-1 transition-all duration-300 text-left group cursor-pointer relative overflow-hidden">
                ...
                <div className="w-14 h-14 bg-[#E6F0FA] border border-[#1E4E8C]/15 rounded-2xl flex items-center justify-center text-[#1E4E8C] mb-6 group-hover:scale-110 transition-transform"><Icon size={26} /></div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="relative group border-2 border-dashed border-slate-200 hover:border-[#1E4E8C]/40 rounded-xl p-3 bg-slate-50/50 hover:bg-white transition-all flex flex-col items-center justify-center text-center cursor-pointer min-h-[90px]">
                          ...
                          <span className="text-[10px] font-bold text-[#1E4E8C] truncate max-w-full px-1">{shopImage1File ? shopImage1File.name : "Shop Image 1 (Max 6MB)"}</span>
                        ...
                        <div className="relative group border-2 border-dashed border-slate-200 hover:border-[#1E4E8C]/40 rounded-xl p-3 bg-slate-50/50 hover:bg-white transition-all flex flex-col items-center justify-center text-center cursor-pointer min-h-[90px]">
                          <ImageIcon className="h-5 w-5 text-slate-400 group-hover:text-[#1E4E8C] mb-1" />
                          <span className="text-[10px] font-bold text-[#1E4E8C] truncate max-w-full px-1">{shopImage2File ? shopImage2File.name : "Shop Image 2 (Max 6MB)"}</span>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div className="relative group border-2 border-dashed border-slate-200 hover:border-[#1E4E8C]/40 rounded-xl p-3 bg-slate-50/50 hover:bg-white transition-all flex flex-col items-center justify-center text-center cursor-pointer min-h-[90px]">
                            <ImageIcon className="h-5 w-5 text-slate-400 group-hover:text-[#1E4E8C] mb-1" />
                            <span className="text-[10px] font-bold text-[#1E4E8C] truncate max-w-full px-1">{nidFrontFile ? nidFrontFile.name : "NID Front Page (Max 6MB)"}</span>
                          ...
                          <div className="relative group border-2 border-dashed border-slate-200 hover:border-[#1E4E8C]/40 rounded-xl p-3 bg-slate-50/50 hover:bg-white transition-all flex flex-col items-center justify-center text-center cursor-pointer min-h-[90px]">
                            <ImageIcon className="h-5 w-5 text-slate-400 group-hover:text-[#1E4E8C] mb-1" />
                            <span className="text-[10px] font-bold text-[#1E4E8C] truncate max-w-full px-1">{nidBackFile ? nidBackFile.name : "NID Back Page (Max 6MB)"}</span>
