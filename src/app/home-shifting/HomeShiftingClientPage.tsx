            ...
            <div className="flex flex-col lg:flex-row items-center gap-8">
              ...
              <div className="flex-shrink-0 w-full max-w-xs lg:max-w-sm">
                <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/3] border border-slate-100 group">
                  <Image src="/jevxo_about_banner.png" alt="Jevxo Services movers carrying boxes during a home shifting job in Dhaka" fill className="object-cover transition-transform duration-700 group-hover:scale-105" priority />
                  ...
                  <form onSubmit={submit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <div onClick={() => fileRef.current?.click()}
                        className="border-2 border-dashed border-slate-200 hover:border-[#1E4E8C]/50 rounded-2xl p-4 text-center cursor-pointer transition-all hover:bg-[#E6F0FA]/50 group">
                    ...
                    <button type="submit" disabled={isLoading}
                      className="w-full bg-gradient-to-r from-[#1E4E8C] to-[#FF7C71] text-white font-black py-4 rounded-2xl shadow-lg shadow-[#1E4E8C]/25 hover:shadow-xl hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center justify-center gap-2 text-sm disabled:opacity-60 disabled:cursor-not-allowed">
            ...
            {WHY.map(({ icon: Icon, title, desc }, i) => (
              <Reveal key={title} delay={i * 60}>
                <div className="bg-white/90 backdrop-blur-md border border-slate-100 rounded-2xl p-4 flex flex-col items-center text-center gap-2 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all h-full">
                  <div className="w-10 h-10 bg-[#E6F0FA] border border-[#1E4E8C]/15 rounded-xl flex items-center justify-center">
