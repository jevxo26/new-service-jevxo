      ...
      <div className="relative overflow-hidden bg-white rounded-3xl border border-slate-100 shadow-sm px-7 py-6">
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <Link
            ...
            className="shrink-0 bg-gradient-to-br from-[#1E4E8C] to-[#123C73] hover:from-[#123C73] hover:to-[#CC5049] text-white font-bold px-6 py-3 rounded-2xl shadow-lg shadow-[#1E4E8C]/25 text-sm transition-all active:scale-[0.985] text-center flex items-center gap-2 w-fit"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex justify-between items-center bg-white p-4 rounded-2xl border border-slate-100 shadow-premium">
            ...
            <Link href="/dashbord/orders" className="text-xs font-semibold text-[#1E4E8C] hover:underline">
              View All Orders
            </Link>
          </div>
          <CustomTable
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-6">
          ...
          <div className="p-4 bg-slate-50 border border-slate-100 rounded-xl space-y-4">
            <div className="flex justify-between items-center text-xs font-bold text-slate-400 uppercase">
              ...
              <span className="text-[#1E4E8C] text-sm">{authUser?.commission_percentage || 0}% Commission</span>
            </div>
            <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden">
              <div className="h-full bg-[#1E4E8C] rounded-full w-3/4" />
            </div>
