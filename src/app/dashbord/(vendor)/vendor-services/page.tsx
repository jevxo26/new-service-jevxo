  ...
  const columns = [
    {
      ...
      render: (item: Service) => (
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-[#E6F0FA] text-[#1E4E8C] rounded-2xl flex items-center justify-center overflow-hidden shrink-0 border border-[#FFF0EB]/40">
            {item.image ? (
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-3 duration-200">
      ...
      {state.isLoading ? (
        ...
        <div className="bg-white border border-slate-100 rounded-3xl p-12 text-center shadow-sm">
          ...
          <button
            onClick={() => state.router.push("/dashbord/vendor-services/create")}
            className="mt-4 bg-[#E6F0FA] hover:bg-[#FFF0EB] text-[#1E4E8C] font-bold px-4 py-2 rounded-xl text-xs transition-all"
          >
