...
export default function VendorWalletPage() {
  ...
  const statusBadge = (status: string) => {
    const map: Record<string, string> = {
      ...
      rejected: "bg-[#E6F0FA] text-[#123C73] border-[#FFF0EB]",
    };
    ...
    },
    {
      ...
      render: (item: Withdraw) => (
        <button
          ...
          className="flex items-center gap-1 bg-[#E6F0FA] border border-[#1E4E8C]/20 hover:bg-[#1E4E8C] hover:text-white text-[#1E4E8C] px-2.5 py-1 rounded-lg text-xs font-bold transition-all shadow-xs cursor-pointer"
    ...
    },
    {
      ...
      render: (item: any) => (
        <button
          ...
          className="bg-brand-primary hover:bg-brand-dark text-white font-bold px-3 py-1.5 rounded-lg text-xs transition-all shadow-sm shadow-[#1E4E8C]/20 disabled:opacity-50"
        >
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-3 duration-200">
        ...
        <div className="flex gap-2">
          {state.withdraws && state.withdraws.length > 0 && (
            <button
              ...
              className="flex items-center gap-2 bg-[#E6F0FA] border border-[#1E4E8C]/20 hover:bg-[#1E4E8C] hover:text-white text-[#1E4E8C] font-bold px-4 py-2.5 rounded-xl text-sm transition-all shadow-xs cursor-pointer"
            >
              <FileText size={16} />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
          ...
          <p className="text-3xl font-bold text-[#1E4E8C] mt-1">{state.commissionPct}%</p>
