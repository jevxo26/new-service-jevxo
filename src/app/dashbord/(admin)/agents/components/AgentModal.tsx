          ...
          <form onSubmit={handleCreateProfile} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative border border-slate-200 bg-slate-50 hover:bg-white rounded-xl px-4 py-2.5 flex items-center justify-between cursor-pointer group transition-all">
                ...
                <span className="text-[10px] font-black uppercase text-[#1E4E8C] group-hover:underline">Browse</span>
                <input
                  type="file"
                  accept="image/*"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <div className="relative border border-slate-200 bg-slate-50 hover:bg-white rounded-xl px-4 py-2.5 flex items-center justify-between cursor-pointer group transition-all">
                  ...
                  <span className="text-[10px] font-black uppercase text-[#1E4E8C] group-hover:underline">File</span>
                  <input
                    type="file"
                    accept="image/*"
