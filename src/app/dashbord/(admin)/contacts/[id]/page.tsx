    ...
    <div className="p-4 md:p-6 lg:p-8 space-y-6 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="bg-white rounded-3xl border border-slate-100 shadow-md p-6 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center text-center space-y-4 pt-2">
              ...
              <div className="space-y-1">
                ...
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[9px] uppercase font-black tracking-wider ${contact.isRead ? "bg-slate-550/10 text-slate-550 border border-slate-200/30" : "bg-[#E6F0FA] text-[#1E4E8C] border border-[#1E4E8C]/20"
                  }`}>
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          {/* Premium Help Card */}
          <div className="bg-[#E6F0FA] rounded-3xl border border-[#1E4E8C]/15 p-6 flex items-start gap-4 shadow-sm">
