    ...
    },
    {
      ...
      render: (row) => (
        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] uppercase font-extrabold tracking-wider ${
          row.isRead ? "bg-slate-100 text-slate-550 border border-slate-200/50" : "bg-[#E6F0FA] text-[#1E4E8C] border border-[#1E4E8C]/20"
        }`}>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-[#E6F0FA] border border-[#1E4E8C]/20 rounded-2xl shadow-xs shrink-0">
