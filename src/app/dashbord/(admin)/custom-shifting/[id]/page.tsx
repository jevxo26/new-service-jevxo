      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm">
            ...
            <div className="grid sm:grid-cols-2 gap-5 bg-[#E6F0FA]/30 rounded-2xl p-5 border border-orange-100/50">
              <div>
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm space-y-5">
            ...
            <div className="space-y-4 pt-2">
              <div className="relative pl-6 pb-2">
                ...
                <div className="absolute left-0 top-0.5 w-3.5 h-3.5 rounded-full bg-[#E6F0FA] border-2 border-[#1E4E8C] flex items-center justify-center">
        ...
        <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm">
              ...
              {shifting.vendor && !isReassigning ? (
                <div className="space-y-4">
                  <div className="bg-[#E6F0FA]/30 border border-orange-100/50 rounded-2xl p-4">
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm space-y-4">
            ...
            {isSuperAdmin ? (
              ...
              <div className="bg-[#E6F0FA]/40 border border-orange-100/40 rounded-2xl p-4 flex items-center justify-between">
                <div>
