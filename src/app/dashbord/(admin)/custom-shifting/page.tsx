      ...
      {isSuperAdmin && (
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          {[
            ...
            { label: lang === "bn" ? "সক্রিয় ভেন্ডর" : "Vendors Active", value: stats.vendorsAssigned, color: "text-[#1E4E8C]", bg: "bg-[#E6F0FA]/80 border-orange-200/50", icon: Users, iconColor: "text-[#1E4E8C] bg-orange-100/80" },
          ].map((s, index) => {
