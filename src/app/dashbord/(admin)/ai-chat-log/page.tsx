...
const CHAT_LOG_KEY = "jevxo_ai_chat_logs";
  ...
  return (
    <button
      ...
      className={`w-full text-left p-4 flex items-start gap-3 transition-all rounded-2xl border ${
        isActive
          ? "bg-[#E6F0FA] border-[#1E4E8C]/20 shadow-sm"
...
function AiWorkflowTester() {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-4 py-3 border-b border-slate-100 bg-[#E6F0FA]/50">
    ...
    <div className="space-y-5 animate-in fade-in slide-in-from-bottom-3 duration-200">
      ...
      <div className="relative overflow-hidden bg-white rounded-3xl border border-slate-100 shadow-sm px-7 py-6">
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-1.5 bg-[#E6F0FA] border border-[#1E4E8C]/20 text-[#1E4E8C] text-[10px] font-bold uppercase tracking-widest px-2.5 py-1 rounded-full mb-3">
            ...
            <div className="px-4 py-4 border-b border-slate-100 bg-white space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] font-black text-[#1E4E8C] bg-[#E6F0FA] border border-[#1E4E8C]/20 px-2 py-0.5 rounded-full">
          ...
          <div className={`flex-1 flex-col min-w-0 border-r border-slate-100 ${
            ...
            {activeSession ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
                ...
                <div className="w-16 h-16 bg-[#E6F0FA] border border-[#1E4E8C]/20 rounded-3xl flex items-center justify-center mx-auto mb-4">
