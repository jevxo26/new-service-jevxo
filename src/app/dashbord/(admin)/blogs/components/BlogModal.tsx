        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:bg-white focus:border-[#1E4E8C]/30 focus:ring-4 focus:ring-[#E6F0FA] transition-all"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:bg-white focus:border-[#1E4E8C]/30 focus:ring-4 focus:ring-[#E6F0FA] transition-all resize-none"
            />
          </div>
            ...
            {images.length < 3 && (
              <div className="relative group border-2 border-dashed border-slate-200 hover:border-[#1E4E8C]/30 rounded-2xl p-6 transition-all bg-slate-50/50 hover:bg-white text-center flex flex-col items-center justify-center cursor-pointer">
                ...
                {isUploadingImage ? (
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <div className="p-3 bg-[#E6F0FA] text-[#1E4E8C] rounded-2xl group-hover:scale-105 transition-transform duration-250">
                      <Upload size={20} />
                    </div>
                    <div>
