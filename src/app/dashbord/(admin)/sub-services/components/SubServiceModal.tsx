      ...
      <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl border border-slate-100 overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6 border-b border-slate-100 flex items-center justify-between">
          <h2 className="text-xl font-bold text-slate-900 font-display flex items-center gap-2">
            <Sparkles className="text-[#1E4E8C]" size={20} />
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div>
            ...
            <Textarea
              ...
              rows={3}
              className="rounded-2xl border border-slate-200/80 bg-white px-4 py-2.5 text-sm text-slate-900 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1E4E8C]/10 focus-visible:border-[#1E4E8C]/80 disabled:cursor-not-allowed disabled:opacity-50 transition-all w-full"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-3 bg-slate-50 p-3 rounded-2xl border border-slate-100">
              ...
              <div className="flex-1 space-y-1">
                <label className="cursor-pointer bg-[#1E4E8C] hover:bg-[#123C73] text-white text-[10px] font-bold px-3 py-2 rounded-lg inline-flex items-center gap-1.5 transition-all active:scale-[0.98] shadow-md shadow-[#1E4E8C]/10">
                  ...
                  <div key={idx} className="space-y-2 border-b border-slate-200 pb-3 last:border-0 last:pb-0">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-2 text-[#1E4E8C] hover:bg-[#FFF0EB] rounded-lg transition-all shrink-0"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
                    <Textarea
                      ...
                      rows={2}
                      className="rounded-xl border border-slate-200/80 bg-white px-3 py-2 text-xs text-slate-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#1E4E8C] w-full"
                    />
                  </div>
                ))}
              </div>
          ...
          <div className="pt-4 border-t border-slate-100 flex justify-end gap-3">
            ...
            <button
              ...
              className="bg-[#1E4E8C] hover:bg-[#123C73] disabled:opacity-50 text-white font-bold px-5 py-2.5 rounded-xl text-sm transition-all active:scale-[0.98] shadow-md shadow-[#1E4E8C]/10"
            >
