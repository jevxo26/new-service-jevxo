        ...
        <div className="space-y-1">
          ...
          {user.status !== "blocked" && (
            <button
              ...
              className="w-full text-left px-3 py-2.5 text-xs text-[#123C73] hover:bg-[#E6F0FA] flex items-center gap-2.5 font-semibold rounded-xl transition-all cursor-pointer"
            >
