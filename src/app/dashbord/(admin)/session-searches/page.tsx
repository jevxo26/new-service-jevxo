...
function getSourceBadge(page: string): { label: string; className: string } {
  ...
  if (page === "/dashbord" || page === "/dashbord/") return { label: "🔍 Global Search", className: "bg-[#E6F0FA] text-[#1E4E8C] border border-[#1E4E8C]/20" };
                ...
                <table className="w-full text-left">
                  ...
                  <tbody>
                    {paginated.map((log, i) => (
                      <tr
                        key={log.id}
                        className={`border-b border-slate-50 hover:bg-[#E6F0FA]/50 transition-colors ${i % 2 === 0 ? "" : "bg-slate-50/30"}`}
                      >
