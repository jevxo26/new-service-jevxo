...
const getStatusColor = (status: string) => {
  switch (status.toLowerCase()) {
    ...
    case 'cancelled': return 'bg-[#E6F0FA] text-[#123C73] border border-[#1E4E8C]/30';
              ...
              {booking.date ? (
                <>
                  ...
                  <div className="flex flex-col items-center w-20 bg-slate-50 border border-slate-200/80 rounded-2xl overflow-hidden shadow-xs shrink-0">
                    <div className="w-full bg-[#1E4E8C] text-white text-[10px] font-black text-center py-1 uppercase tracking-wider">
                          ...
                          return (
                            <label
                              ...
                              className={`flex items-start gap-3 p-3 rounded-2xl cursor-pointer border transition-all ${isChecked
                                  ? "bg-rose-50/20 border-[#1E4E8C]/40 shadow-xs"
                            ...
                            >
                              <input
                                ...
                                className="mt-1 w-4 h-4 text-brand-primary border-slate-300 rounded focus:ring-brand-primary/20 accent-[#1E4E8C]"
                              />
      ...
      {!(typeof rawRole === 'string' && rawRole.toLowerCase() === 'agent') && (
        <div className="bg-white rounded-3xl p-6 border border-rose-100/60 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <button
            ...
            disabled={isDeleting}
            className="flex items-center gap-2 px-5 py-3 text-xs font-extrabold text-[#123C73] bg-white border border-[#1E4E8C]/30 hover:bg-[#E6F0FA] hover:border-[#1E4E8C]/50 rounded-2xl transition-all shadow-xs active:scale-95 disabled:opacity-50"
          >
            <Trash2 size={14} />
