        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-2 mb-3">
              ...
              {/* Upload Button Block */}
              <label className="aspect-square border-2 border-dashed border-slate-200 hover:border-[#1E4E8C] rounded-2xl flex flex-col items-center justify-center text-slate-400 hover:text-[#1E4E8C] cursor-pointer transition-all bg-slate-50/50 hover:bg-[#E6F0FA]/30">
                {isUploadingImage ? (
