    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-3 duration-200">
      ...
      {!isHeroesLoading && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="bg-white border border-slate-200/50 p-5 rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)] flex items-center justify-between relative overflow-hidden group hover:border-[#1E4E8C]/20 transition-all">
            <div className="absolute top-0 right-0 w-24 h-24 rounded-full bg-[#E6F0FA] blur-2xl -mr-6 -mt-6 group-hover:bg-[#E6F0FA]/80 transition-colors" />
            ...
            <div className="relative p-3 bg-[#E6F0FA] text-[#1E4E8C] rounded-2xl">
              <LayoutGrid size={22} />
            </div>
          </div>
      ...
      {isHeroesLoading ? (
        ...
        <div className="bg-white border border-slate-200/60 rounded-3xl p-16 text-center shadow-[0_8px_30px_rgb(0,0,0,0.02)] max-w-2xl mx-auto border-dashed">
          <div className="w-16 h-16 bg-[#E6F0FA] text-[#1E4E8C] rounded-2xl flex items-center justify-center mx-auto mb-5 border border-[#1E4E8C]/10 shadow-inner">
            <LayoutGrid size={28} />
          </div>
