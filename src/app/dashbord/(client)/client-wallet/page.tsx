        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6 flex flex-col items-center lg:items-start">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-4 w-full max-w-[420px] sm:max-w-[480px] lg:max-w-[520px]">
              <button className="bg-[#1E4E8C] hover:bg-[#123C73] text-white text-xs sm:text-sm font-bold px-8 py-3.5 sm:py-4 rounded-2xl flex items-center justify-center gap-2 shadow-sm shadow-[#1E4E8C]/10 active:scale-[0.98] transition-all w-full sm:w-auto flex-1 cursor-pointer">
              ...
              <div className="flex items-center justify-between p-3 bg-slate-50/50 rounded-2xl border border-slate-100/40">
                ...
                <button
                  ...
                  className={`w-9 h-5 rounded-full p-0.5 transition-colors duration-200 focus:outline-none cursor-pointer ${
                    autoRecharge ? "bg-[#1E4E8C]" : "bg-slate-200"
                  }`}
                >
                  <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          <div className="lg:col-span-3 space-y-4">
            <div className="flex justify-between items-center">
              ...
              <button className="text-xs font-bold text-[#1E4E8C] hover:underline focus:outline-none cursor-pointer">
            ...
            <div className="space-y-3">
              <div className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm flex items-center justify-between gap-4">
                ...
                <span className="text-[9px] font-bold text-[#1E4E8C] bg-[#E6F0FA] px-2 py-0.5 rounded-lg">
              ...
              <div className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm flex items-center justify-between gap-4">
                ...
                <button className="p-2 bg-slate-50 hover:bg-[#E6F0FA] text-slate-400 hover:text-[#1E4E8C] rounded-xl transition-colors focus:outline-none cursor-pointer">
                  <Trash2 size={14} />
                </button>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 bg-[#1E4E8C] text-white p-6 rounded-[32px] shadow-sm relative overflow-hidden flex flex-col justify-between min-h-[220px]">
