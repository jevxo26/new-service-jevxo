        ...
        <div className="flex gap-2">
          {myCompletedBookings.length > 0 && (
            <button
              ...
              className="p-2 bg-[#E6F0FA] border border-[#1E4E8C]/20 hover:bg-[#1E4E8C] hover:text-white text-[#1E4E8C] rounded-xl shadow-xs transition-all flex items-center gap-1.5 focus:outline-none cursor-pointer text-[10px] font-bold"
            >
              <FileText size={14} />
                ...
                myCompletedBookings.map((b: any) => (
                  <tr key={b.id} className="hover:bg-slate-50/30 transition-colors">
                    <td className="px-3 md:px-6 py-3 md:py-4 flex items-center gap-3">
                      <div className="p-2.5 rounded-xl shrink-0 bg-[#E6F0FA] text-[#1E4E8C]">
                        <Sparkles size={16} />
                      </div>
                      <div>
                    ...
                    <td className="px-3 md:px-6 py-3 md:py-4">
                      <span className="text-[9px] font-bold px-2 py-0.5 rounded-lg bg-[#E6F0FA] text-[#1E4E8C] uppercase">
                        {lang === "bn" ? "খরচ" : "EXPENSE"}
                      </span>
                    </td>
                    <td className="px-3 md:px-6 py-3 md:py-4 pr-6 text-right">
                      <button
                        ...
                        className="inline-flex items-center gap-1 bg-[#E6F0FA] border border-[#1E4E8C]/20 hover:bg-[#1E4E8C] hover:text-white text-[#1E4E8C] px-2.5 py-1 rounded-lg text-[10px] font-bold transition-all shadow-xs cursor-pointer"
