...
export default function SupportBanner() {
  ...
  return (
    <div className="bg-[#E6F0FA]/45 rounded-[40px] border border-[#FFF0EB]/30 p-8 sm:p-10 text-center space-y-8 mt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 divide-y md:divide-y-0 md:divide-x divide-rose-100/50">
        ...
        <div className="space-y-4 pt-4 md:pt-0">
          <div className="w-14 h-14 bg-white border border-[#FFF0EB]/70 rounded-full flex items-center justify-center text-[#1E4E8C] mx-auto shadow-sm">
          ...
          <button className="bg-[#1E4E8C] hover:bg-[#1E4E8C] text-white text-xs font-bold px-6 py-2.5 rounded-full shadow-sm shadow-[#1E4E8C]/10 active:scale-[0.98] transition-all w-fit mx-auto focus:outline-none cursor-pointer">
        ...
        <div className="space-y-4 pt-6 md:pt-0 md:pl-6">
          ...
          <button className="border border-[#1E4E8C] hover:bg-[#E6F0FA]/40 text-[#1E4E8C] text-xs font-bold px-6 py-2.5 rounded-full active:scale-[0.98] transition-all w-fit mx-auto focus:outline-none cursor-pointer">
