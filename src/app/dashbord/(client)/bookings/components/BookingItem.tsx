    ...
    <div className="bg-white rounded-[28px] border border-slate-100 p-6 shadow-sm space-y-6 flex flex-col justify-between hover:shadow-md transition-shadow">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-[#E6F0FA] border border-[#FFF0EB] rounded-2xl flex items-center justify-center text-[#1E4E8C]">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1.5">
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-[#E6F0FA] text-[#123C73]">
          ...
          <div className="flex flex-col gap-2">
            {booking.vendor && (
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-full bg-[#FFF0EB] flex items-center justify-center text-[#123C73] font-bold text-xs border border-[#1E4E8C]/30">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-slate-50">
        <div className="flex items-center gap-2 flex-wrap">
          {booking.vendor && (
            <button
              ...
              className="flex items-center gap-1.5 text-[#1E4E8C] bg-[#E6F0FA] hover:bg-[#FFF0EB] px-3 py-1.5 rounded-lg text-xs font-bold transition-colors focus:outline-none cursor-pointer"
            >
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto flex-wrap">
          <button
            ...
            className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 bg-[#E6F0FA] border border-[#1E4E8C]/20 hover:bg-[#1E4E8C] hover:text-white text-[#1E4E8C] text-xs font-bold py-2.5 px-4 rounded-2xl transition-all cursor-pointer shadow-xs active:scale-[0.98]"
          >
            <Download size={14} />
          ...
          <Link
            ...
            className="flex-1 sm:flex-none bg-[#1E4E8C] hover:bg-[#123C73] text-white text-xs font-bold py-2.5 px-4 sm:px-6 rounded-2xl transition-all shadow-sm shadow-[#1E4E8C]/10 active:scale-[0.98] inline-block text-center"
          >
