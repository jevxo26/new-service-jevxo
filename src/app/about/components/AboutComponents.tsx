...
export const PILLARS = [
  { title: "100% Background-Vetted Team", description: "Every technician undergoes biometric NID check, police verification, and a rigorous skills assessment.", icon: ShieldCheck, bg: "bg-[#E6F0FA] text-[#1E4E8C]" },
  { title: "Transparent Fixed Pricing", description: "Say goodbye to surprise charges. Get detailed rate cards and fixed billing estimates before booking.", icon: Award, bg: "bg-[#E6F0FA] text-[#1E4E8C]" },
  { title: "Premium Damage Guarantee", description: "All service appointments are backed by Jevxo Services's damage protection guarantee for absolute peace of mind.", icon: Heart, bg: "bg-[#E6F0FA] text-[#1E4E8C]" },
  { title: "24/7 Priority Support", description: "Our dedicated helpline handles every booking from dispatch to post-service warranty questions.", icon: Sparkles, bg: "bg-[#E6F0FA] text-[#1E4E8C]" },
];
