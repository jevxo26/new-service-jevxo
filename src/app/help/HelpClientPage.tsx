    ...
    <div className="bg-transparent overflow-hidden relative flex-1 flex flex-col">
      ...
      <section ref={heroRef} className="relative pt-8 pb-4 md:pt-12 md:pb-6 z-10">
        <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
          <div className="inline-flex items-center gap-2 text-[10px] font-extrabold text-[#1E4E8C] uppercase tracking-[.12em] bg-[#E6F0FA] px-3 py-1 rounded-full border border-[#1E4E8C]/20 mb-3">
          ...
          <h1 className="text-[clamp(24px,4vw,36px)] font-black text-slate-900 tracking-[-0.03em] leading-[1.1] mb-2.5">
            Client <span className="text-[#1E4E8C]">Help Center</span> & Guides
          </h1>
          ...
          <div className="relative max-w-lg mx-auto">
            <div className="flex items-center bg-white/90 backdrop-blur-md border border-slate-200/80 shadow-[0_4px_20px_rgba(0,0,0,0.02)] rounded-xl px-3 py-2 focus-within:border-[#1E4E8C] focus-within:ring-2 focus-within:ring-[#1E4E8C]/15 transition-all">
              ...
              {searchQuery && (
                <button
                  ...
                  className="text-slate-400 hover:text-[#1E4E8C] text-[10px] font-extrabold px-1.5 py-0.5 rounded hover:bg-slate-50 transition-colors"
                >
                  Clear
                </button>
              )}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          {hasResults ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 pb-3 border-b border-slate-100">
                        <div className="w-9 h-9 rounded-xl bg-[#E6F0FA] border border-[#1E4E8C]/15 flex items-center justify-center text-[#1E4E8C] shrink-0">
                      ...
                      <div className="space-y-5">
                        {section.items.map((item: any, idx: number) => (
                          <div key={idx} className="space-y-2 group/item">
                            <h3 className="text-xs font-black text-slate-800 flex items-center gap-2 group-hover/item:text-[#1E4E8C] transition-colors duration-200">
                            ...
                            <div className="bg-[#FFFDFB] border border-rose-100/30 rounded-xl px-3 py-2 text-[10px] sm:text-[11px] font-semibold text-slate-600 flex gap-2">
                              <span className="text-[#1E4E8C] shrink-0">What happens:</span>
            ...
            <div className="bg-white/50 backdrop-blur-sm border border-dashed border-slate-200 rounded-2xl p-8 text-center max-w-xl mx-auto">
              <div className="w-10 h-10 rounded-full bg-[#E6F0FA] flex items-center justify-center mx-auto mb-2 text-[#1E4E8C]">
      ...
      <section className="py-8 md:py-10 border-t border-slate-100 bg-[#FFFDFB]/40 relative z-10">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <div className="text-center mb-5">
            <span className="inline-flex items-center gap-1.5 text-[10px] font-extrabold text-[#1E4E8C] uppercase tracking-[.12em] bg-[#E6F0FA] px-3 py-1 rounded-full border border-[#1E4E8C]/20 mb-2">
          ...
          <div className="grid sm:grid-cols-3 gap-3">
            {/* Support Card 1: Call */}
            <div className="bg-white border border-slate-100 hover:border-[#1E4E8C]/20 rounded-2xl p-4 shadow-[0_4px_20px_rgba(0,0,0,0.015)] flex flex-col items-center text-center transition-all duration-300 group">
              <div className="w-9 h-9 rounded-xl bg-[#E6F0FA] border border-[#1E4E8C]/15 flex items-center justify-center text-[#1E4E8C] mb-2.5 group-hover:scale-105 transition-transform">
              ...
              <a
                ...
                className="text-[10px] font-bold text-[#1E4E8C] hover:underline flex items-center gap-0.5 mt-auto"
              >
                01813-333373
