...
export const STATUS_CONFIG: Record<BookingStatus, { label: string; pillBg: string; pillText: string; borderColor: string; iconBg: string; iconText: string; glowColor: string }> = {
  confirmed: { label: "Confirmed", pillBg: "bg-[#E6F0FA] border-[#1E4E8C]/20", pillText: "text-[#1E4E8C]", borderColor: "border-l-[#1E4E8C]", iconBg: "bg-[#E6F0FA]", iconText: "text-[#1E4E8C]", glowColor: "shadow-[0_0_15px_rgba(30,78,140,0.08)]" },
...
export function useBookingsState() {
  ...
  const getStats = () => {
    ...
    return [
      { label: "Total Bookings", value: bookings.length.toString(), sub: "All time records", icon: Briefcase, stripeColor: "bg-[#1E4E8C]", iconContainerColor: "bg-[#E6F0FA] border-[#1E4E8C]/15", iconColor: "text-[#1E4E8C]", gradient: "from-white via-white to-orange-50/15", borderColor: "hover:border-[#1E4E8C]/25", shadow: "hover:shadow-[0_20px_40px_rgba(30,78,140,0.05)]" },
