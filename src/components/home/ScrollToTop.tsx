      ...
      <div className="relative flex items-center justify-center">
        ...
        {!isAtTop && (
          <motion.span
            ...
            className="absolute inset-0 rounded-full bg-gradient-to-r from-[#1E4E8C] to-[#FF7C71] blur-md pointer-events-none z-[-1]"
          />
        )}
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.92 }}
          onClick={handleClick}
          className="relative w-12 h-12 bg-gradient-to-r from-[#1E4E8C] to-[#FF7C71] text-white flex items-center justify-center border border-white/10 cursor-pointer overflow-hidden"
