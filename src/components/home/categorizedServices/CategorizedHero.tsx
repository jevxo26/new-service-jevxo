        ...
        {words.map((word, idx) => {
          ...
          return (
            <React.Fragment key={idx}>
              <span className={isHighlighted ? "text-[#1E4E8C]" : ""}>
                {word}
              </span>
              {idx < words.length - 1 ? " " : ""}
            </React.Fragment>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_420px] lg:grid-cols-[1fr_460px] gap-8 md:gap-12 items-center">
          ...
          <div className="flex flex-col gap-5 min-w-0">
            ...
            <div className="flex flex-wrap gap-2">
              <div className="inline-flex items-center gap-2 bg-[#fff0f0] text-[#1E4E8C] px-4 py-1.5 rounded-full text-xs font-semibold">
                <Zap className="w-3.5 h-3.5" />
                Top Rated Services
              </div>
              {categoryName && (
                <div className="inline-flex items-center gap-1.5 bg-[#E6F0FA] border border-[#1E4E8C]/20 text-[#1E4E8C] px-4 py-1.5 rounded-full text-xs font-medium">
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              >
                <Heart
                  size={20}
                  className={isSaved ? "fill-[#1E4E8C] text-[#1E4E8C]" : "text-slate-300"}
                />
              </motion.button>
            </div>
            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-row gap-3 pt-2 w-full sm:w-auto">
              <motion.button
                ...
                className="flex items-center justify-center gap-2 bg-[#1E4E8C] hover:bg-[#123C73]
