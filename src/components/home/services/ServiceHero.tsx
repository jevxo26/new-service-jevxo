    ...
    <section className="bg-white pt-6 pb-6 md:py-16 px-4 sm:px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
        ...
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-medium text-slate-900 leading-tight mb-4 max-w-3xl mx-auto">
          Find the best home <span className="text-[#1E4E8C]">services</span>
        </h1>
        ...
        >
          ...
          <Button
            type="submit"
            className="w-full md:w-auto bg-[#1E4E8C] hover:bg-[#123C73] text-white font-extrabold px-6 sm:px-8 py-3.5 h-auto rounded-xl md:rounded-full transition-all duration-200 shadow-sm active:scale-95 text-sm sm:text-base flex-shrink-0 cursor-pointer"
          >
            Search
          </Button>
        </motion.form>
                ...
                return (
                  <Link
                    ...
                    className={`group flex items-center gap-2 px-4 py-2 rounded-full border font-extrabold text-xs transition-all duration-200 hover:-translate-y-0.5 no-underline cursor-pointer shadow-sm ${isActive
                      ? "border-[#1E4E8C] text-[#1E4E8C] bg-gradient-to-br from-[#E6F0FA] to-[#FFEDE3]"
                      : "border-slate-100 text-slate-600 bg-white hover:border-[#1E4E8C]/40 hover:text-slate-800 hover:shadow-md"
                      }`}
                  >
                    <span
                      className={`flex items-center justify-center w-5 h-5 rounded-full transition-colors duration-200 ${isActive ? "bg-[#1E4E8C]/15" : "bg-slate-50 group-hover:bg-[#1E4E8C]/10"
                        }`}
                    >
                      <Icon size={12} className={isActive ? "text-[#1E4E8C]" : "text-slate-400 group-hover:text-[#1E4E8C]"} />
                    </span>
                    {label}
                  </Link>
                );
              ...
              >
                {apiCategories.map((cat: any) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className={`flex items-center justify-center w-5 h-5 rounded-full transition-colors duration-200 ${isActive ? "bg-[#1E4E8C]/15" : "bg-slate-50"
                          }`}
                      >
                        <Icon size={12} className={isActive ? "text-[#1E4E8C]" : "text-slate-400"} />
                      </span>
                      {label}
                    </Link>
                  );
