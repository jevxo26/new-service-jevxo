          ...
          >
            ...
            <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-xl bg-[#E6F0FA] flex items-center justify-center text-[#1E4E8C]">
              ...
              <div className="flex items-center gap-3">
                <button
                  type="button"
                  onClick={onClearAll}
                  className="text-xs font-bold text-slate-500 hover:text-[#1E4E8C] hover:bg-[#E6F0FA]/50 transition-colors bg-slate-100 px-3 py-2 rounded-xl cursor-pointer"
                >
                  Clear all
                </button>
                <button
                  type="button"
                  onClick={onClose}
                  className="w-9 h-9 flex items-center justify-center rounded-xl bg-slate-100 text-slate-600 hover:text-[#1E4E8C] hover:bg-[#E6F0FA] transition-all cursor-pointer"
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-8 scrollbar-thin">
                      ...
                      return (
                        <motion.button
                          ...
                          className={`flex items-center gap-2.5 px-3.5 py-3 rounded-xl border text-xs font-bold transition-all duration-200 text-left cursor-pointer ${
                            isActive
                              ? "border-[#1E4E8C] bg-[#E6F0FA] text-[#1E4E8C] shadow-[0_4px_12px_rgba(255,90,95,0.08)]"
              ...
              <section className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-extrabold text-[#1E4E8C] bg-[#E6F0FA] px-2.5 py-1 rounded-lg">
                  ...
                  <div className="relative h-2 bg-slate-100 rounded-full mb-4">
                    ...
                    <input
                      ...
                      className="absolute w-full h-2 top-0 left-0 appearance-none bg-transparent z-10 cursor-pointer
                        ...
                        [&::-webkit-slider-thumb]:border-[3px] [&::-webkit-slider-thumb]:border-[#1E4E8C]
                    ...
                    return (
                      <motion.label
                        ...
                        className={`flex items-center justify-between gap-3 px-4 py-3 rounded-xl border cursor-pointer transition-all ${
                          isActive
                            ? "border-[#1E4E8C] bg-[#E6F0FA] shadow-[0_4px_12px_rgba(255,90,95,0.05)]"
                      ...
                      >
                        <span className="flex items-center gap-3">
                          <input
                            ...
                            className="w-4 h-4 accent-[#1E4E8C] cursor-pointer"
                          />
                    ...
                    return (
                      <motion.button
                        ...
                        className={`flex items-center justify-between gap-3 px-4 py-3 rounded-xl border text-xs font-bold transition-all cursor-pointer ${
                          isActive
                            ? "border-[#1E4E8C] bg-[#E6F0FA] text-[#1E4E8C]"
                            : "border-slate-100 bg-slate-50/50 text-slate-600 hover:border-slate-200"
                        }`}
                      >
                        <span className="flex items-center gap-3">
                          <Icon size={15} strokeWidth={2.5} className={isActive ? "text-[#1E4E8C]" : "text-slate-400"} />
                          {opt.label}
                        </span>
            ...
            <div className="px-6 py-4 border-t border-slate-100 bg-slate-50 flex items-center gap-4">
              <button
                type="button"
                onClick={onClose}
                className="flex-1 py-3.5 rounded-2xl bg-[#1E4E8C] hover:bg-[#123C73] text-white font-extrabold text-xs shadow-lg shadow-rose-200 hover:shadow-xl active:scale-98 transition-all text-center uppercase tracking-wider cursor-pointer"
              >
    ...
    <aside className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm space-y-6 sticky top-24">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div className="flex items-center gap-2">
          <SlidersHorizontal size={15} className="text-[#1E4E8C]" strokeWidth={2.5} />
          <span className="text-sm font-extrabold text-slate-800">Filters</span>
        </div>
        <button
          type="button"
          onClick={onClearAll}
          className="text-xs font-bold text-slate-500 hover:text-[#1E4E8C] transition-colors cursor-pointer"
        >
          Clear all
        </button>
      </div>
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[11px] font-extrabold text-[#1E4E8C] bg-[#E6F0FA] px-2 py-0.5 rounded-lg">
