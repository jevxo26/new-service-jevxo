                              ...
                              >
                                      ...
                                      {apiCategories.map((cat: any) => {
                                        ...
                                        return (
                                          <Link
                                            ...
                                            className="flex items-center gap-3 p-2.5 rounded-2xl border border-transparent hover:border-orange-100 hover:bg-[#E6F0FA] group/item transition-all duration-200 hover:shadow-sm"
                                ...
                                <div className="w-[220px] bg-gradient-to-br from-[#FFF9F6] to-[#FFF1E9] border border-orange-100/60 rounded-2xl p-5 flex flex-col justify-between relative overflow-hidden shrink-0">
                                  ...
                                  <div className="relative z-10">
                                    <div className="inline-flex items-center gap-1 text-[8px] font-black uppercase tracking-wider text-[#1E4E8C] bg-[#E6F0FA] border border-[#1E4E8C]/15 px-2.5 py-1 rounded-full mb-3">
                  ...
                  <AnimatePresence>
                    {savedCount > 0 && (
                      <motion.span
                        ...
                        className="absolute top-0 right-0 min-w-[16px] h-[16px] bg-[#1E4E8C] text-white text-[8px] font-black rounded-full flex items-center justify-center px-1 shadow-[0_0_8px_rgba(30,78,140,0.5)] border border-white"
                      >
                        {savedCount}
                      </motion.span>
                    )}
              ...
              {!mounted || authLoading ? (
                ...
                <div className="hidden md:flex items-center gap-3">
                  ...
                  >
                    <Link
                      href="/login"
                      className="flex items-center gap-1.5 font-bold text-[#1E4E8C] bg-rose-50/50 hover:bg-rose-50 border border-rose-100/60 hover:border-[#1E4E8C]/30 py-2 px-4 rounded-xl text-xs lg:text-sm transition-all duration-200"
                    >
                  ...
                  >
                    <Link
                      href="/signup"
                      className="flex items-center gap-1.5 bg-gradient-to-r from-[#1E4E8C] to-[#ff7b36] hover:from-[#e55610] hover:to-[#ff6c21] text-white font-bold py-2 px-4.5 rounded-xl text-xs lg:text-sm transition-all duration-200 shadow-[0_4px_14px_-3px_rgba(30,78,140,0.22)] hover:shadow-[0_6px_20px_-3px_rgba(30,78,140,0.35)]"
                    >
              ...
              <div className="px-4.5 py-4 space-y-2">
                      ...
                      <motion.div key={i} variants={mobileItemVariants} className="space-y-1">
                        <div
                          className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl transition-all ${
                            active
                              ? "text-[#1E4E8C] bg-[#E6F0FA] font-bold border-l-2 border-[#1E4E8C]"
                                    ...
                                    return (
                                      <Link
                                        ...
                                        className={`flex flex-col items-center gap-1.5 p-2.5 rounded-xl border transition-all ${
                                          isCategoryActive
                                            ? "bg-[#E6F0FA] border-[#1E4E8C]/20 text-[#1E4E8C] font-bold"
                                      ...
                                      >
                                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 transition-colors ${
                                          isCategoryActive ? "bg-[#1E4E8C] text-white" : "bg-white border border-slate-200/60 text-slate-400"
                                        }`}>
                ...
                {!mounted || authLoading ? (
                  ...
                  <motion.div variants={mobileItemVariants} className="pt-3 border-t border-slate-100 mt-2 space-y-3">
                    ...
                    <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50/40 border border-slate-100">
                      ...
                      <div className="min-w-0 flex-grow">
                        ...
                        <span className="inline-block px-1.5 py-0.5 text-[8px] font-bold text-[#1E4E8C] bg-[#E6F0FA] border border-[#1E4E8C]/15 rounded-full mt-1.5 leading-none">
                          {profile.roleName}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <Link
                        href={role === "client" ? "/dashbord/overview" : "/dashbord"}
                        className="flex flex-col items-center justify-center p-2.5 rounded-xl bg-white border border-slate-200/50 text-slate-700 hover:bg-[#E6F0FA] hover:text-[#1E4E8C] hover:border-[#1E4E8C]/20 transition-all gap-1 cursor-pointer"
                        onClick={() => setIsOpen(false)}
                      >
                  ...
                  <motion.div variants={mobileItemVariants} className="grid grid-cols-2 gap-3 pt-3 border-t border-slate-100 mt-2">
                    <Link
                      href="/login"
                      className="flex items-center justify-center gap-1.5 py-2.5 text-slate-700 font-bold text-xs border border-slate-200 bg-white rounded-xl hover:border-[#1E4E8C] hover:text-[#1E4E8C] transition-all cursor-pointer"
                      onClick={() => setIsOpen(false)}
                    >
                    ...
                    <Link
                      href="/register"
                      className="flex items-center justify-center gap-1.5 py-2.5 bg-gradient-to-r from-[#1E4E8C] to-[#FF7A37] text-white font-bold text-xs rounded-xl shadow-sm hover:shadow hover:shadow-orange-500/10 transition-all active:scale-[0.98] cursor-pointer"
                      onClick={() => setIsOpen(false)}
                    >
