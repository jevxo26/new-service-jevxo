      ...
      <div className="w-full md:max-w-[92%] lg:max-w-[960px] xl:max-w-[1140px] min-[1440px]:max-w-[1280px] 2xl:max-w-[1400px] mx-auto px-4 md:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 md:mb-14">
          ...
          <h2 className="text-lg md:text-xl lg:text-2xl font-medium text-slate-900 tracking-tight flex items-center justify-center gap-2">
            <ThumbsUp className="w-5 h-5 md:w-6 md:h-6 text-[#1E4E8C]" />
            Our Top <span className="text-[#1E4E8C]">Providers</span>
          </h2>
              ...
              >
                  ...
                  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2">
                    <div className="relative">
                      {provider.avatar ? (
                        ...
                        <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#1E4E8C] to-[#5B92E5] text-white flex items-center justify-center font-black text-lg border-4 border-white shadow-md uppercase">
                ...
                <div className="pt-10 px-4 pb-4 flex flex-col gap-3 flex-1">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[11px] font-semibold mt-0.5 line-clamp-1 text-[#1E4E8C]">
                      {provider.specialty}
                    </p>
                  </div>
