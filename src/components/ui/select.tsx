...
export function CustomSelect({
  ...
  const selectStyles = {
    ...
    option: (base: any, state: any) => ({
      ...base,
      backgroundColor: state.isSelected ? "#1E4E8C" : state.isFocused ? "#FFF0EB" : "white",
    ...
    return (
      <div 
        ...
        className={cn(
          ...
          isSelected ? "bg-[#1E4E8C] text-white" : isFocused ? "bg-[#FFF0EB] text-slate-900" : "bg-white text-slate-700"
        )}
      >
        {data.icon && (
